...
7. `202609180007_direct_rental_status.sql`
8. `202609190008_availability_phone_images.sql`

For an existing project with migrations 001–007 already applied, run only 008. It improves date availability checks and normalizes booking phone numbers. See [account settings and installation](docs/ACCOUNT-AND-INSTALL.md) for email confirmation and PWA setup.
